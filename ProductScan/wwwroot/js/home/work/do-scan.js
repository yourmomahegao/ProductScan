...
function getScanResult(serialNumber, fasNumberFormatString, contractLotID, stepID) {
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.statusCode == "STEP_DUP") {
                showScanDuplicateNotification();

                // Setting description message
                $(".scan-duplicate-container #scan-duplicate-label #error").text(response.description);
            }
